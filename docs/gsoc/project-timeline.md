...
Length: **14 weeks** (~25 h/week at 350h), confirmed with the contributor. It is not set in stone; we'll revisit at the midterm if the pace warrants.
...
- **Weeks 7–8**: Jul 6 – Jul 19
  - Multi-agent, the primary post-midterm goal. It is a stretch: not needed to pass midterm, and the first thing to cut if behind schedule.
